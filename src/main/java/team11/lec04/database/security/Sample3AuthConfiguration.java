package team11.lec04.database.security;
...
public class Sample3AuthConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(AuthenticationManagerBuilder auth) throws Exception {
    ...
    auth.inMemoryAuthentication().withUser("orange").password(passwordEncoder().encode("mikan")).roles("USER");
    ...
    auth.inMemoryAuthentication().withUser("master")
        .password("$2y$10$wuPCN1y.ThYozN3Ur4d4r.QstITTKtv/K24DTpsxtfBZvGgIueBWi").roles("ADMIN");
  }
